...
export default async function Home() {
  ...
  const [{ data: rec }, { data: slp }, { data: cyc }, { data: wrk }, { data: jrn }, { data: profile }] = await Promise.all([
    ...
    sb.from("whoop_journal").select("day, question, answer").order("day", { ascending: false }).limit(10000),
